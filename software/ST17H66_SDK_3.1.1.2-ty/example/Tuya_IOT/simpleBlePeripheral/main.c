...
static void hal_rfphy_init(void)
{
    ...
    g_rfPhyFreqOffSet   =RF_PHY_FREQ_FOFF_40KHZ; //RF_PHY_FREQ_FOFF_N120KHZ
    //============config xtal 16M cap
...
static void hal_init(void)
{
	...
	ty_system_enter_sleep();//    ty_system_exit_sleep();
    
    xflash_Ctx_t cfg =
    {
        .spif_ref_clk   =   SYS_CLK_RC_32M,//SYS_CLK_DLL_64M,
...
//	rf_DTM_RX_rfoffset_calibration();
    ...
    LOG("[REST CAUSE] %d",g_system_reset_cause);
    app_main();
}
